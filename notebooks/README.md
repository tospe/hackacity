...
This should allow you to directly import `src/hackacity2022` in your notebook.
...
Run `python -m ipykernel install --user --name="hackacity2022"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called hackacity2022 should be available in the
