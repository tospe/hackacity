...
Clone this repository (requires git ssh keys)
    ...
    git clone --recursive ssh://git@git.fraunhofer.pt/spaghettis/hackacity2022.git
    cd hackacity2022 && git init

Install dependencies

    conda create -y -n hackacity2022 python=3.10
    conda activate hackacity2022
...
If you publish work that uses spaghettis, please cite spaghettis as follows:

```bibtex
@misc{spaghettis hackacity2022,
  author = {Fraunhofer Spaghettis},
